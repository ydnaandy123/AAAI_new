...
tf.flags.DEFINE_string("logs_dir", "./logs_ae_rgbs", "path to logs directory")
tf.flags.DEFINE_integer("epochs", "20", "epochs for training")
        ...
        if FLAGS.mode == 'train':
            ...
            for epoch in range(0, epochs):
                ...
                for batch in range(0, batches):
                    x_batch, y_batch = aaai_parser.load_mat_train_datum_batch_aug(batch*batch_size, (batch+1)*batch_size)
