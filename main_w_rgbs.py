...
tf.flags.DEFINE_string("logs_dir", "./logs_w_rgbs", "path to logs directory")
tf.flags.DEFINE_integer("epochs", "12", "epochs for training")
...
def main(args=None):
    ...
    aaai_parser.load_mat_train_w_paths()
    # Hyper-parameters
