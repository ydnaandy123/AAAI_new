...
tf.flags.DEFINE_string("logs_dir", "./logs_xss_rgbs", "path to logs directory")
tf.flags.DEFINE_integer("epochs", "18", "epochs for training")
...
def main(args=None):
    ...
    aaai_parser.load_mat_train_ss_paths()
    # Hyper-parameters
    ...
    with tf.Session() as sess:
        ...
        if FLAGS.mode == 'train':
            ...
            for idx, mat_valid_path in enumerate(aaai_parser.mat_test_paths):
                ...
                sio.savemat('./dataset/AAAI/{}_w/{}'.format(
